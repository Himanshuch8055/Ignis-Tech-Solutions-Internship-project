          ...
          <div class="-m-8 flex flex-wrap items-center justify-between">
            ...
            <div class="w-auto p-8">
              <ul class="-m-5 flex flex-wrap items-center">
                <li class="p-5">
                  <a class="font-medium text-gray-600 hover:text-orange-400" href="#">
                    Privacy Policy
                  </a>
                </li>
                <li class="p-5">
            ...
            <div class="w-auto p-8">
              <div class="-m-1.5 flex flex-wrap">
                <div class="w-auto p-1.5">
                  <a href="#">
                    <div class="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-orange-400">
                      <svg
                        width="8"
                        height="14"
                        viewBox="0 0 8 14"
